...
function addRowDT(data) {
    ...
    for (var i = 0; i < data.length; i++) {
        tabla.fnAddData([
            ...
            data[i].Edad,
            data[i].Direccion,
            '<button type="button" value="Actualizar" title="Actualizar" class="btn btn-black btn-edit" data-target="#imodal" data-toggle="modal"><i class="fa fa-check-square-o" aria-hidden="true"></i></button>&nbsp;' +
            '<button type="button" value="Eliminar" title="Eliminar" class="btn btn-primary btn-delete"><i class="fa fa-minus-square-o" aria-hidden="true"></i></button>'
