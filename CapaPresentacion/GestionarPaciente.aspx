    ...
    <section class="content">
        ...
        <div align="center">
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnRegistrar" runat="server" CssClass="btn bg-black" Width="200px" Text="Registrar" OnClick="btnRegistrar_Click" />
                    </td>
                    <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                    <td>
                        <asp:Button ID="btnCancelar" runat="server" CssClass="btn bg-maroon" Width="200px" Text="Cancelar" />
                    </td>
                </tr>
            </table>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn bg-black id="btnactualizar">Actualizar</button>
                </div>
            </div>
        </div>
    </div>
